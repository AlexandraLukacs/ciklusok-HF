...
print("Várt eredmény: 1, BAM, BUMM, BAM, 7, BAM, BUMM")
ciklusok.feladat4(9)
print()

print("Teszteset 1: - se 3-mal osztható, se 2-vel nem. 11")
print("Várt eredmény: 1, BAM, BUMM, BAM, 7, BAM, BUMM, BAM, 11")
...
print("Teszteset 1: - nem adok meg paramétert")
